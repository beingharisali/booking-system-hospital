...
const CountryList: React.FC = () => {
  const countries = [
    { sr: 1, code: '0092', countryName: 'Pakistan', shortName: 'PAK' },
  ];
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-between items-center mt-4 text-sm text-gray-600">
        <div>
          Showing 1 to {countries.length} of {countries.length} entries
        </div>
      </div>
    </div>
  );
