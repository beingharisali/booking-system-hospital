...
const EmailConfigurationList: React.FC = () => {
  const emailConfigurations: EmailConfigurationData[] = [
  ];

  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">EMail Configuration List</h2>
      ...
      <div className="flex justify-between items-center mt-4 text-sm text-gray-600">
        <div>
          Showing {emailConfigurations.length > 0 ? 1 : 0} to {emailConfigurations.length} of {emailConfigurations.length} entries
        </div>
      </div>
    </div>
  );
